...
class HibernateBookingRepositoryTest extends AbstractTest {
    ...
    @Test
    void given_3bookingsinrepository_when_findallbookings_then_returnequalsbookings() throws CreateGuestException, CreateBookingException, RoomAlreadyExistsException {
        // given
    ...
    @Test
    void given_booking_when_addbookingtorepository_then_returnequalsbooking() throws CreateGuestException, CreateBookingException, RoomAlreadyExistsException {
        // given
    ...
    private Booking createBookingDummy() throws CreateGuestException, CreateBookingException, RoomAlreadyExistsException {
