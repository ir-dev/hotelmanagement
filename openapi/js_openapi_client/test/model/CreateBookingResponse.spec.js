...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenApiDefinition.CreateBookingResponse();
  });
  ...
  describe('CreateBookingResponse', function() {
    it('should create an instance of CreateBookingResponse', function() {
      ...
      //var instance = new OpenApiDefinition.CreateBookingResponse();
      //expect(instance).to.be.a(OpenApiDefinition.CreateBookingResponse);
    });
