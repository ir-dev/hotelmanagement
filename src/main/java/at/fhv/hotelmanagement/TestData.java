...
public class TestData implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        Guest g5 = GuestFactory.createGuest(this.guestRepository.nextIdentity(), orgaEmpty, String.valueOf(Salutation.MR),"Ivo", "Reich", LocalDate.of(1996,6,21), ad5, "");
        Guest g6 = GuestFactory.createGuest(this.guestRepository.nextIdentity(), orgaEmpty, String.valueOf(Salutation.MR),"Justin", "Kirchmann", LocalDate.of(1995,2,27), ad6, "");
        ...
        PaymentInformation paymentInformation5 = new PaymentInformation("Ivo Reich", "4531 5431 3513 3341", "01/28", "942", String.valueOf(PaymentType.CASH));
        PaymentInformation paymentInformation6 = new PaymentInformation("Justin Kirchmann", "4332 5462 3435 4542", "02/22", "325", String.valueOf(PaymentType.CASH));
