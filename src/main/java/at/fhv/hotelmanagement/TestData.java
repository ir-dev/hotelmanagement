...
public class TestData implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        Guest g1 = new Guest(new GuestId("1"), orgaEmpty, Salutation.DIVERSE, "Hüseyin", "Arziman", LocalDate.of(1999,12,24), ad1, "I don't want the housekeeping to disturb us");
        Guest g2 = new Guest(new GuestId("2"), orga1, Salutation.MISTER,"Fritz", "Mayer", LocalDate.of(1979,12,24), ad2, "");
